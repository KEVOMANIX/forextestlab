...
export function PreLaunchAccessCard({ compact = false }: { compact?: boolean }) {
  return (
    <aside className={`relative overflow-hidden rounded-3xl border border-brand-400/35 bg-[linear-gradient(135deg,rgba(20,184,166,.18),rgba(17,23,37,.96)_58%,rgba(59,107,255,.1))] shadow-card ${compact ? "p-6 sm:p-7" : "p-7 sm:p-9"}`}>
