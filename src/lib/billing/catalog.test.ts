...
describe("billing catalogue", () => {
  it("keeps prices in provider subunits and formats them for users", () => {
    vi.stubEnv("PAYSTACK_USD_MONTHLY_PRICE", "1200");
    expect(getCheckoutProduct("pro_monthly_usd").amount).toBe(1200);
  ...
  it("requires the checkout kill switch and real plan code", () => {
    ...
    vi.stubEnv("PAYSTACK_USD_MONTHLY_PLAN_CODE", "PLN_realexample");
