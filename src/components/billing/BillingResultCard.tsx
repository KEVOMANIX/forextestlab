...
export function BillingResultCard({
  ...
  const colors = tone === "success" ? "bg-brand-400/10 text-brand-300 border-brand-400/25" : tone === "pending" ? "bg-amber-400/10 text-amber-300 border-amber-400/25" : "bg-loss/10 text-loss border-loss/25";
