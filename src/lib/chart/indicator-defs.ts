...
export type InputType = "number" | "source" | "select" | "boolean" | "anchor" | "time" | "text" | "color";
...
export const INDICATOR_DEFS: IndicatorDef[] = [
  ...
  // ── Trend — geometric / structural (price pane) ──
  {
    ...
    inputs: [
      ...
      { key: "asiaEnd", label: "Asia end", type: "time", default: "00:00", section: "calculation" },
      { key: "asiaColor", label: "Asia colour", type: "color", default: "#2962ff", section: "calculation" },
      { key: "asiaTransparency", label: "Asia transparency", type: "number", default: 78, min: 0, max: 100, section: "calculation" },
      { key: "asiaBorderWidth", label: "Asia border width", type: "number", default: 1, min: 0, max: 4, section: "calculation" },
      { key: "asiaLineEnabled", label: "Asia start line", type: "boolean", default: false, section: "calculation" },
      { key: "asiaLineTime", label: "Asia line time", type: "time", default: "20:00", section: "calculation" },
      { key: "asiaLineColor", label: "Asia line colour", type: "color", default: "#2962ff", section: "calculation" },
      { key: "asiaLineStyle", label: "Asia line style", type: "select", default: "dashed", options: [{ value: "solid", label: "Solid" }, { value: "dashed", label: "Dashed" }, { value: "dotted", label: "Dotted" }], section: "calculation" },
      { key: "asiaLineWidth", label: "Asia line width", type: "number", default: 1, min: 1, max: 4, section: "calculation" },
      { key: "londonEnabled", label: "London box", type: "boolean", default: true, section: "calculation" },
      { key: "londonName", label: "London name", type: "text", default: "London", section: "calculation" },
      { key: "londonStart", label: "London start", type: "time", default: "03:00", section: "calculation" },
      { key: "londonEnd", label: "London end", type: "time", default: "08:00", section: "calculation" },
      { key: "londonColor", label: "London colour", type: "color", default: "#f9ab00", section: "calculation" },
      { key: "londonTransparency", label: "London transparency", type: "number", default: 76, min: 0, max: 100, section: "calculation" },
      { key: "londonBorderWidth", label: "London border width", type: "number", default: 1, min: 0, max: 4, section: "calculation" },
      { key: "londonLineEnabled", label: "London start line", type: "boolean", default: true, section: "calculation" },
      { key: "londonLineTime", label: "London line time", type: "time", default: "03:00", section: "calculation" },
      { key: "londonLineColor", label: "London line colour", type: "color", default: "#ff00b8", section: "calculation" },
      { key: "londonLineStyle", label: "London line style", type: "select", default: "dashed", options: [{ value: "solid", label: "Solid" }, { value: "dashed", label: "Dashed" }, { value: "dotted", label: "Dotted" }], section: "calculation" },
      { key: "londonLineWidth", label: "London line width", type: "number", default: 1, min: 1, max: 4, section: "calculation" },
      { key: "newYorkEnabled", label: "New York box", type: "boolean", default: true, section: "calculation" },
      { key: "newYorkName", label: "New York name", type: "text", default: "New York", section: "calculation" },
      { key: "newYorkStart", label: "New York start", type: "time", default: "08:00", section: "calculation" },
      { key: "newYorkEnd", label: "New York end", type: "time", default: "12:00", section: "calculation" },
      { key: "newYorkColor", label: "New York colour", type: "color", default: "#089981", section: "calculation" },
      { key: "newYorkTransparency", label: "New York transparency", type: "number", default: 76, min: 0, max: 100, section: "calculation" },
      { key: "newYorkBorderWidth", label: "New York border width", type: "number", default: 1, min: 0, max: 4, section: "calculation" },
      { key: "newYorkLineEnabled", label: "New York start line", type: "boolean", default: false, section: "calculation" },
      { key: "newYorkLineTime", label: "New York line time", type: "time", default: "08:00", section: "calculation" },
      { key: "newYorkLineColor", label: "New York line colour", type: "color", default: "#089981", section: "calculation" },
      { key: "newYorkLineStyle", label: "New York line style", type: "select", default: "dashed", options: [{ value: "solid", label: "Solid" }, { value: "dashed", label: "Dashed" }, { value: "dotted", label: "Dotted" }], section: "calculation" },
      { key: "newYorkLineWidth", label: "New York line width", type: "number", default: 1, min: 1, max: 4, section: "calculation" },
    ],
    plots: [],
    precision: null,
    short: () => "Sessions",
