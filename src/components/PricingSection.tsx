...
export function PricingSection() {
  return (
    <Section
      ...
      description="Simple international pricing with secure checkout. No trading commissions, deposits, or hidden platform fees."
    ...
    >
      ...
      <div className="mt-8 grid gap-3 rounded-2xl border border-white/10 bg-surface-900/70 p-4 text-sm text-slate-400 sm:grid-cols-3 sm:p-5">
        <span className="flex items-center gap-2"><Globe2 size={16} className="text-brand-300" aria-hidden /> International payment methods</span>
