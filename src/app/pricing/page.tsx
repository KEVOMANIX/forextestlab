...
import { ArrowRight, BadgeCheck, CreditCard, Globe2, Smartphone } from "lucide-react";
      ...
      <section className="py-16 sm:py-20">
        <div className="container-page">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-3">
            <div className="card p-5"><Globe2 size={20} className="text-brand-300" aria-hidden /><h2 className="mt-3 font-semibold text-white">Worldwide cards</h2><p className="mt-2 text-sm leading-relaxed text-slate-400">International checkout priced in USD.</p></div>
            ...
            <div className="card p-5"><Smartphone size={20} className="text-brand-300" aria-hidden /><h2 className="mt-3 font-semibold text-white">Kenya access pass</h2><p className="mt-2 text-sm leading-relaxed text-slate-400">A renewable KES 30-day M-PESA option is planned for local customers.</p></div>
          </div>
        </div>
      </section>
